...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__12028 = cljs.core.second(format);
var G__12029 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__12028,G__12029) : ajax.easy.keyword_response_format_element.call(null,G__12028,G__12029));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__12032_SHARP_){
return ajax.easy.keyword_response_format_element(p1__12032_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__12039){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12040__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12040__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12040__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__12040,map__12040__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__12045){
var vec__12046 = p__12045;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12046,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12046,(1),null);
var fexpr__12049_12067 = (cljs.core.truth_(ok)?h:e);
(fexpr__12049_12067.cljs$core$IFn$_invoke$arity$1 ? fexpr__12049_12067.cljs$core$IFn$_invoke$arity$1(result) : fexpr__12049_12067.call(null,result));
...
;})(h,e,map__12040,map__12040__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__12068){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12069__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12069__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12069__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12069__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12069__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
