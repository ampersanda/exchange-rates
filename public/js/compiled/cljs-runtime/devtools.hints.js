...
var G__13301 = cljs.core.PersistentArrayMap.EMPTY;
var G__13302 = native_stack_trace;
var G__13303 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__13304 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__13301,G__13302,G__13303,G__13304) : cljs.stacktrace.parse_stacktrace.call(null,G__13301,G__13302,G__13303,G__13304));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e13310){var _e = e13310;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___13326 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5455__auto___13326)){
var seen_errors_13327 = temp__5455__auto___13326;
if(cljs.core.truth_(seen_errors_13327.has(self))){
} else {
seen_errors_13327.add(self);

var temp__5457__auto___13328 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5457__auto___13328)){
var sense_13329 = temp__5457__auto___13328;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_13329)].join('');
} else {
}
}
} else {
