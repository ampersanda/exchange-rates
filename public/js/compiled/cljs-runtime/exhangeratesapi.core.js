...
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12102__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12102__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
return alert((function (){var G__12104 = status;
switch (G__12104) {
case (0):
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12104)].join('')));
...
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(exhangeratesapi.core.app_state,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"exchange","exchange",843073210),new cljs.core.Keyword(null,"value","value",305978217)], null),p1__12098_SHARP_.currentTarget.value);
...
return (new cljs.core.PersistentVector(null,3,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"option","option",65132272),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),p1__12099_SHARP_], null),p1__12099_SHARP_],null));
});})(exchange,base,rates,bases,added_rates,date,value_to_exchange,selected_option,base_placeholder,api_url))
...
return (new cljs.core.PersistentVector(null,3,(5),cljs.core.PersistentVector.EMPTY_NODE,[new cljs.core.Keyword(null,"li","li",723558921),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(p1__12100_SHARP_)], null),[cljs.core.str.cljs$core$IFn$_invoke$arity$1((value_to_exchange * new cljs.core.Keyword(null,"rate","rate",-1428659698).cljs$core$IFn$_invoke$arity$1(p1__12100_SHARP_)))," ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"base","base",185279322).cljs$core$IFn$_invoke$arity$1(p1__12100_SHARP_))].join('')],null));
});})(exchange,base,rates,bases,added_rates,date,value_to_exchange,selected_option,base_placeholder,api_url))
...
var G__12106 = new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [exhangeratesapi.core.exchange_rates], null);
var G__12107 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__12106,G__12107) : reagent.core.render_component.call(null,G__12106,G__12107));
});
