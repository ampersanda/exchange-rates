...
var G__13788 = devtools.prefs.pref(v);
v = G__13788;
continue;
} else {
return v;
...
}catch (e13791){var _e__13298__auto__ = e13791;
return false;
}})();
...
}catch (e13795){var _e__13298__auto__ = e13795;
return false;
}})();
...
}catch (e13797){var _e__13298__auto__ = e13797;
return false;
}}
}
});
...
var vec__13807 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13807,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13807,(1),null);
...
return cljs.core.some((function (p1__13821_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__13821_SHARP_);
}),template);
});
